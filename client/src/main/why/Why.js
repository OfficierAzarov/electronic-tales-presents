        ...
        return (
            <div id="why" class="animated">
                ...
                <p>
                    ...
                    <span class="break-text"><img src={confused} alt="" /><img src={confused2} alt="" /><img src={confused3} alt="" /></span>
                    <span class="break-text">D&eacute;gommons le syndrome de l'imposteur ensemble&nbsp;!</span>
                    <span class="break-text">Electronic Tales entend être un safe-space d'apprentissage pour et par les
                    ...
                    <span class="break-text">D&eacute;marr&eacute; en d&eacute;cembre 2019, notre projet est actuellement en cours de création. Il sera totalement gratuit et open-source. Le premier release est prévu pour la rentrée 2020. D'ici l&agrave;, nous avons besoin de toi&nbsp;!</span></span>
                </p>
